...
import com.dd.medication.medicine.ui.SeachMedicineActivity.MyAdapter;
...
public class CaptureActivity1 extends BaseActivity implements Callback {
	...
	public void handleDecode(final String barcode) {
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		...
		if (handler == null) {
			handler = new CaptureActivityHandler(CaptureActivity1.this);
		}
	}
