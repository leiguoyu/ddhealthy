...
import com.dd.medication.login.dll.ViewPagerAdapter;

/**
 * 引导界面图层ui
 * **/
public class GuideViewPagerActivity extends BaseActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(GuideViewPagerActivity.this, LoginActivity.class);
